        ...
        >
          <div className="verify-student-status-form">
            ...
            <div className="status-form-single-input">
              ...
              <Select defaultValue="aadhar" style={{ width: "100%" }} onChange={handleCancel}>
            ...
            <div className="status-form-instruction">
              ...
              <p className="single-instruction">1. Please Upload a clear image of the document.</p>
              <p className="single-instruction">2. Your full name and college name should be visible.</p>
              <p className="single-instruction">3. It should be a valid document.</p>
            </div>
